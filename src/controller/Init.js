...
exports.Init = {
    ...
    async createTables(req, res) {
        ...
        const parametro    = "CREATE TABLE parametro (cod_parametro serial not null, imagem_loja character(60), titulo_loja character(45), descricao_loja character(50), contato_loja character(14), endereco_loja character(60), numero_loja character(4), complemento_loja character(20), cep_loja character(9), pedido_minimo_loja real, horario_ini_funcionamento_loja character(5), horario_fim_funcionamento_loja character(5), funcionamento_semana_seg int, funcionamento_semana_ter int, funcionamento_semana_qua int, funcionamento_semana_qui int, funcionamento_semana_sex int, funcionamento_semana_sab int, funcionamento_semana_dom int)";
