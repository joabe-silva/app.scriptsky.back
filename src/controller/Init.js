...
exports.Init = {
    ...
    async createTables(req, res) {
        ...
        const produto = "CREATE TABLE produto (cod_produto serial not null, imagem character(60), titulo character(80), descricao character(100), preco character(50), desconto character(50), situacao integer);"
